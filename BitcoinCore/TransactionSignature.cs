...
#pragma warning disable 618
		static readonly TransactionSignature _Empty = new TransactionSignature(new ECDSASignature(BitcoinCore.BouncyCastle.Math.BigInteger.ValueOf(0), BitcoinCore.BouncyCastle.Math.BigInteger.ValueOf(0)), SigHash.All);
