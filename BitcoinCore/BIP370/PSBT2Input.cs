...
public class PSBT2Input : PSBTInput
{
	...
	public LockTime? UnifiedTimeLock
	{
		get =>
			this switch
			{
				{ LockTimeHeight: { } v } => new BitcoinCore.LockTime(v),
				{ LockTimeHeight: null, LockTime: { } v } => new BitcoinCore.LockTime(v),
				_ => null
			};
		set
		{
