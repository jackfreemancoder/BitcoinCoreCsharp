...
using System.Linq;
using static BitcoinCore.TaprootConstants;
...
#nullable restore
	...
	public class ScriptEvaluationContext
	{
		...
		{
			ScriptVerify = BitcoinCore.ScriptVerify.Standard;
...
#endif
				default:
					throw new NotSupportedException("BitcoinCore bug 29174: Contact BitcoinCore developers, this should never happen");
			}
		}
...
#pragma warning disable 618
				...
				var R = 4;
				var S = 6 + nLenR;
				var newS = new BitcoinCore.BouncyCastle.Math.BigInteger(1, vchSig, S, nLenS);
				var newR = new BitcoinCore.BouncyCastle.Math.BigInteger(1, vchSig, R, nLenR);
