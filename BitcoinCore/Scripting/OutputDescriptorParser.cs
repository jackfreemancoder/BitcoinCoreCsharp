...
using static BitcoinCore.Scripting.PubKeyProvider;
using static BitcoinCore.Scripting.ParserUtil;
using System.Linq;
using BitcoinCore.DataEncoders;
using P = BitcoinCore.Scripting.Parser.Parser<char, BitcoinCore.Scripting.OutputDescriptor>;
