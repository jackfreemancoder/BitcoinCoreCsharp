...
using BitcoinCore.Protocol.Behaviors;
using System;
...
namespace BitcoinCore.Protocol
{
	...
	public class AddressManager : IBitcoinSerializable
	{
		...
		{
			if (!value)
				throw new InvalidOperationException("Bug in AddressManager, should never happen, contact BitcoinCore developers if you see this exception");
		}
