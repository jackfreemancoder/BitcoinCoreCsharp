...
namespace BitcoinCore.BIP322
{
	...
	public abstract class BIP322Signature
	{
		...
		/// <summary>
		/// Check if the PSBT is a PSBT created by <see cref="BitcoinCore.BitcoinAddress.CreateBIP322PSBT(string, uint, uint, uint, Coin[])"/>
		/// </summary>
		...
		/// <param name="signatureType">The type of signature (<see cref="BitcoinCore.BIP322.SignatureType.Legacy"/>> isn't supported)</param>
