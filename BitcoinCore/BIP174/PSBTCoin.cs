...
using HDKeyPathKVMap = System.Collections.Generic.SortedDictionary<BitcoinCore.PubKey, BitcoinCore.RootedKeyPath>;
using HDTaprootKeyPathKVMap = System.Collections.Generic.SortedDictionary<BitcoinCore.TaprootPubKey, BitcoinCore.TaprootKeyPath>;
...
namespace BitcoinCore
{
	public abstract class PSBTCoin
	{
		...
		protected HDTaprootKeyPathKVMap hd_taprootkeypaths = new HDTaprootKeyPathKVMap(Comparer<BitcoinCore.TaprootPubKey>.Default);
