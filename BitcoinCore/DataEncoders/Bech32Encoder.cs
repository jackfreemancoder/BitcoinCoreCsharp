...
namespace BitcoinCore.DataEncoders
{
...
#if HAS_SPAN
		// We don't use this one, but old version of BitcoinCore.Altcoins does, we prefer not causing problems if there is a mismatch of
		// assembly between BitcoinCore.Altcoins and BitcoinCore.
