...
namespace BitcoinCore.Crypto
{
	internal class ECKey
	{
		...
		static ECKey()
		{
			_Secp256k1 = BitcoinCore.BouncyCastle.Crypto.EC.CustomNamedCurves.Secp256k1;
		...
		{
			if (isPrivate)
				_Key = new ECPrivateKeyParameters(new BitcoinCore.BouncyCastle.Math.BigInteger(1, vch), DomainParameter);
			else
			{
...
#pragma warning restore 618
			...
			var n = curve.N;
			var i = BitcoinCore.BouncyCastle.Math.BigInteger.ValueOf((long)recId / 2);
#pragma warning disable 618
...
#pragma warning restore 618
			...
			var e = new BitcoinCore.BouncyCastle.Math.BigInteger(1, message.ToBytes());
			...
			var eInv = BitcoinCore.BouncyCastle.Math.BigInteger.Zero.Subtract(e).Mod(n);
#pragma warning disable 618
...
#pragma warning restore 618
		...
		private static ECPoint DecompressKey(BitcoinCore.BouncyCastle.Math.BigInteger xBN, bool yBit)
		{
